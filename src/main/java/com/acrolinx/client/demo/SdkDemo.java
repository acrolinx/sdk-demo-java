...
public class SdkDemo
{
    ...
    /**
     * The signature as configured in the Acrolinx license. You'll get the signature for your
    ...
    public static void main(String[] args) throws URISyntaxException, InterruptedException, AcrolinxException
    {
         ...
         * https://github.com/acrolinx/acrolinx-coding-guidance/blob/main/topics/configuration.md#
         * authentication SignInSuccess signInSuccess = acrolinxEndpoint.signInWithSSO(SSO_TOKEN,
        ...
        CheckResult checkResult = acrolinxEndpoint.check(accessToken,
                ...
                progress -> System.out.println(
                        "Progress: " + progress.getPercent() + "% (" + progress.getMessage() + ")"));
